...
absl::Status SignerBaseImpl::sign(Http::RequestMessage& message, Credentials credentials,
...
absl::Status SignerBaseImpl::sign(Http::RequestHeaderMap& headers, Credentials credentials,
