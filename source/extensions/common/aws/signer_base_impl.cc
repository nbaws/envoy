...
absl::Status SignerBaseImpl::sign(Http::RequestMessage& message, Credentials credentials, bool sign_body,
...
absl::Status SignerBaseImpl::signEmptyPayload(Http::RequestHeaderMap& headers, Credentials credentials,
                                              const absl::string_view override_region) {
...
absl::Status SignerBaseImpl::signUnsignedPayload(Http::RequestHeaderMap& headers, Credentials credentials,
                                                 const absl::string_view override_region) {
...
absl::Status SignerBaseImpl::sign(Http::RequestHeaderMap& headers, Credentials credentials, const std::string& content_hash,
                                  const absl::string_view override_region) {
